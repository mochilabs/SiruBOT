...
const SHARD_MANAGER_URL =
  process.env.SHARD_MANAGER_URL || "http://localhost:3001";
const SHARD_MANAGER_AUTH_KEY =
  process.env.SHARD_MANAGER_AUTH_KEY || "youshallnotpass";
